class QuotationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @quotation.save
        format.html {redirect_to edit_customer_quotation_path(@customer,@quotation), :notice => 'quotation was successfully created.'}
      else
  ...
  def destroy
    @customer = Customer.find(params[:customer_id])
    #@customers = Customer.find(:all, :conditions => "owner_id = 3") #
